...
public class IntroActivity extends AhoyOnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AhoyOnboarderCard firstScreen = new AhoyOnboarderCard(getString(R.string.first_title), getString(R.string.first_description), R.drawable.ic_first);
        ...
        AhoyOnboarderCard secondScreen = new AhoyOnboarderCard(getString(R.string.second_title), getString(R.string.second_description), R.drawable.ic_second);
        ...
        AhoyOnboarderCard thirdScreen = new AhoyOnboarderCard(getString(R.string.third_title), getString(R.string.third_description), R.drawable.icon_four);
        ...
        setFinishButtonTitle("Thử ngay");

        setFinishButtonDrawableStyle(ContextCompat.getDrawable(this, R.drawable.rounded_button));
    }
    @Override
    public void onFinishButtonPressed() {
        Intent showMainIntent = new Intent(IntroActivity.this, MainActivity.class);
